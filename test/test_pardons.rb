...
class PardonParserTest < Test::Unit::TestCase
  ...
  def test_date_extraction
    date, role, crime, sentence = PardonParser.get_trial_details(AMalePardon)
    ...
    date, role, crime, sentence = PardonParser.get_trial_details(AFemalePardon)
    ...
    date, role, crime, sentence = PardonParser.get_trial_details(AnotherPardon)
    ...
    date, role, crime, sentence = PardonParser.get_trial_details(MultipleCharges)
